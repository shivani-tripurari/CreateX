...
const Services = () => {
  return (
    <div className='h-[180vh] md:h-[160vh] fold:h-[200vh] ipad-air:h-[100vh] xl:h-[210vh] bg-[#F5F5DC]'>
        ...
        />
        <div className='group flex flex-row justify-center items-center gap-x-3 mt-20 ml-12 mb-1 h-12 w-[20rem] md:w-[40rem] fold:w-[38rem] ipad-air:w-[62rem] xl:w-[80rem] border-2 border-[#171717]'>
